...
1. [GitHub 저장소](https://github.com/pengdo-myorange/BeforeSend)에 접속합니다.
2. 초록색 **Code** 버튼을 클릭한 뒤, **Download ZIP**을 선택합니다.
3. 다운로드된 `BeforeSend-main.zip` 파일을 원하는 위치에 압축 해제합니다.
